...
# Install this chart
helm install postgresql cigip-upv/platform-postgresql \
  --namespace platform \
  --create-namespace
```
...
helm install postgresql . -n platform --create-namespace
```
