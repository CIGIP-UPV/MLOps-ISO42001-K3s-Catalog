...
> CronJob for scheduled retraining and a drift-triggered Job template integrated with MLflow.
...
# Install this chart
helm install training-jobs cigip-upv/platform-training-jobs \
  --namespace platform \
  --create-namespace
```
...
cd MLOps-ISO42001-K3s-Catalog/catalog/platform/ai-lifecycle/training-jobs/manifests
helm dependency update .
helm install training-jobs . -n platform --create-namespace
```
