...
> OPC-UA to MQTT/Kafka bridge (EMQX Neuron) that pulls tags from PLC/SCADA endpoints and forwards them into the edge event bus.
...
# Install this chart
helm install opc-ua-gateway cigip-upv/edge-opc-ua-gateway \
  --namespace edge \
  --create-namespace
```
...
cd MLOps-ISO42001-K3s-Catalog/catalog/edge/data-ingestion/opc-ua-gateway/manifests
helm dependency update .
helm install opc-ua-gateway . -n edge --create-namespace
```
