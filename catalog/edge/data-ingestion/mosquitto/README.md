...
# Install this chart
helm install mosquitto cigip-upv/edge-mosquitto \
  --namespace edge \
  --create-namespace
```
...
helm install mosquitto . -n edge --create-namespace
```
